...
data_root = '/home/ai-trainning-server/work/cyl/data/ai_city_challenge_2024/track_5/'
classes = ('motorbike','DHelmet','DNoHelmet','P1Helmet','P1NoHelmet','P2Helmet','P2NoHelmet','P0Helmet','P0NoHelmet')

load_from = 'pretrained/co_dino_5scale_swin_large_16e_o365tococo-005.pth'
pretrained = None
# model settings
num_dec_layer = 6
lambda_2 = 2.0
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        classes=classes,
        ann_file=data_root + 'aicity2024_track5_train/train_all.json',
        img_prefix=data_root + 'aicity2024_track5_train/images/',
    ...
    test=dict(
        type=dataset_type,
        classes=classes,
        ann_file=data_root + 'submit_sample.json',
        img_prefix=data_root + 'aicity2024_track5_test/images_V2/',
        pipeline=test_pipeline))

evaluation = dict(interval=9999, metric='bbox', save_best='auto')
