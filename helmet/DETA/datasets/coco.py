...
def build(image_set, args):
    ...
    import os
    PATHS = {
        "train": ('./data/ai_city_challenge_2024/track_5/aicity2024_track5_train/images',
                  './data/ai_city_challenge_2024/track_5/aicity2024_track5_train/train_all_fullname.json'),
        "val": ('./data/ai_city_challenge_2024/track_5/aicity2024_track5_train/images',
                './data/ai_city_challenge_2024/track_5/aicity2024_track5_train/train_all_fullname.json'),
    }
