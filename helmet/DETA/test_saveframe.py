...
ap.add_argument("-v", "--input_video_dir", help="path to input video dir", default="./track5/test_set")
...
def main():
    ...
    for file in tqdm(os.listdir(output_video_dir)):
        f = open(os.path.join(output_video_dir.replace('images','labels'), file.replace('.png', '.txt')), 'w')
